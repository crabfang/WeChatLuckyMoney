...
public class WeChatPlugin implements IPlugin {
    public final static String PLUGIN_PACKAGE_NAME = "com.tencent.mm";
    ...
    public void checkNodeInfo(int eventType) {
        ...
        boolean containActivity = currentActivityName.contains(WECHAT_LUCKMONEY_CHATTING_ACTIVITY)
        ...
        if (node1 != null && containActivity) {
            ...
            if (signature.generateSignature(node1, excludeWords)) {
                ...
                mReceiveNode = node1;
                Log.d("WeChatPlugin", this.signature.toString());
            }
            return;
        }
